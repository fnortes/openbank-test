...
export default function Home() {
  ...
  return (<section>
    ...
    <p>A continuación enumero algunos puntos que considero serían a tener en cuenta respecto al test realizado:</p>
    <ul>
      <li>
        A pesar de que la estructura del proyecto estaba preparada con componentes de clase, y puesto que la
        versión de React lo permite, he realizado todos los componentes como funciones, con el uso de
        <strong>Hooks</strong> y <strong>Context</strong> para un mejor rendimiento.
      </li>
      <li>
        <h4>En cuanto a dependecias añadidas al package.json</h4>
        <ul>
          <li>
            A pesar de no ser un requisito en la prueba, creo que el manejarse con las rutas en React es importante.
            Por tanto, he añadido <strong>wouter</strong>, que es mucho menos pesada que react-router-dom,
            y bajo mi punto de vista más limpia de utilizar.
          </li>
          <li>
            Para el tema de documentación, he añadido <strong>jsdoc</strong> y <strong>better-docs</strong> (como
            dependecia de desarrollo), con el fin de aprovechar los comentarios del propio código y montar
            una interfaz web independiente en la que poder consultar todos los componentes de la aplicación y su uso.
            Para lanzar bastaría con ejecutar <strong>npm run docs</strong> (añadida al README.md del proyecto).
            En la entrega, va incluida la carpeta docs generada, por si hubiera algún problema, a pesar de que con
            comando anterior se puede regenerar en cualquier momento.
          </li>
        </ul>
      </li>
      <li>
        He añadido una pequeña configuración al <strong>jsconfig.json</strong> para cambiar el baseUrl y tener unas
        rutas en los imports del proyecto más limpias.
      </li>
      <li>
        Aprovechando el añadido de un enrutador, he dejado como Home la página original del proyecto y en una
        página independiente el desarrollo del propio Wizard.
      </li>
      <li>
        He añadido el uso de carga de componentes <strong>Lazy</strong>, tanto a la hora de cargar las 2 páginas
        existentes, como para cargar cada uno de los 3 pasos del Wizard.
      </li>
      <li>
        Respecto a estilos, aunque podría haber incorparado algún framework tipo Bootstrap para partir de una base
        al hacer los layouts, he preferido hacerlos todos a mano y desde cero, entiendo que era mejor opción para
        el objetivo de la prueba (Salvo los estilos del Spinner, que son copiados).
      </li>
      <li>
        En el Wizard, si se mete una contraseña que da KO en el api, el link de la pantalla de error te lleva al
        inicio del Wizard cargando de nuevo todos los datos introducidos la primera vez (tanto el check para
        aceptar del paso 1, como todos los datos del paso 2). Soy consciente de que no sería lo ideal en una
        situación real, sobre todo por el tema tan delicado como son las contraseñas, pero decidí hacerlo así
        porque me parecío muy práctico y usable a la hora de estar haciendo pruebas.
      </li>
    </ul>
    <LinkTerciary align="center" to="/wizard">Entrar al Wizard</LinkTerciary>
